...
Задача: создание новостного  сайта. Период выполнения - 7 дней.
Уточнения:
...
Реализовать админку (ссылки + миддлвер)
...
Задания выполнил в полной мере, относительно написанного ТЗ.
